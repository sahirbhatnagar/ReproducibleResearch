...
\pause
\begin{enumerate}
\item Non-disclosure of \underline{          .}
...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-slr2} 
...
\item \href{run:./finalv2.pdf}{\underline{\textcolor{blue}{ What if one observation was wrong?}}}
...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-slr7} 
...
{\centering \includegraphics[width=.45\linewidth]{figure/beamer-boring-plots1} 
...
\begin{itemize}
\item Highly customizable for \href{run:../examples/knit_expand/mtcars.Rnw}{\underline{\textcolor{blue}{ repetitive}}}  \href{run:../examples/knit_expand/template.Rnw}{\underline{\textcolor{blue}{ tasks}}}
\item Easily extendible to \href{run:../examples/markdown/mwe.Rmd}{\underline{\textcolor{blue}{ Markdown documents}}} (Gruber 2004) 
...
\item Interactive \href{run:../examples/shiny/prostate.R}{\underline{\textcolor{blue}{ web applications}}} to present results
...
\begin{frame}
\frametitle{If you could only take away one thing from today's talk...}
